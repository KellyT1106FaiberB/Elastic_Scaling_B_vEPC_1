...
void init(char *argv[]) {
	...
	mme_rep_clients2.resize(g_workers_count); /////// esto lo cambie yooooooooooooooooooooooooooooooooooooooooooooooooooo
...
int i;
	...
	for (i = 0; i < 50; i++) {
		mme_rep_server_threads[i] = thread(handle_replication,i);cout<<"replllication"<<endl; //aqui modifique yoooooooooo comentar el cout
		
	}
//}
		cout<<"thread runner"<<endl; //aqui modifique yoooooooooo comentar el cout
...
void run3(){
	...
	for (i = 0; i < 50; i++) {
		...
		cout << "MME replication started" << endl; //aqui modifique yoooooooooo comentar el cout
		}
	}
...
void run() {
	...
	TRACE();cout << "MME server started" << endl; /// qui   mooooooooooooooooooooooooooooooooooooooooooooooooooooodimodifi
...
cout<<"holaaaaaaaaaaaa"<<endl;
	//cout << "MME replication started" << endl;  ////////modifique 
